...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoresListView.setOnItemClickListener(focusOnRecord);
    ...
    /**
     * Tap on score moves the camera and focus on it
     */
    ...
    /**
     * Load the records from the scoreList to the map
     *
     * @param googleMap
     */
    @Override
    ...
    /**
     * Connect the scoreList to the listView
     */
